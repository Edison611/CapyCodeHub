...
const Home = () => {
  return (
    <div>
      ...
      <br />
      <HeroLink image={scouting} title={"Scouting"} text={"A webpage to help with scouting"} buttons={[{name: "Scouting", link: "/scouting"}, {name: "Vex Via", link: "/vexvia"}, {name: "HS Worlds Division Predictor", link: "/predictor"}, {name: "MS Worlds Division Predictor", link: "/predictorMS"}]} />
