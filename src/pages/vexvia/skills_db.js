...
function SkillsPageDB() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`${API_BASE_URL}/events/${event_id}/skills?season[]=${season}`, {
          method: 'GET',
          headers: {
    ...
    fetchData();
  }, [event_id, season]); // Make sure to add any dependencies if needed
